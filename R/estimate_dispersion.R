...
#' @param cell.types.cutoff Minimum number of cells in a cell type * age group. Default is 10.
#'
...
#' tms_marrow_cell_types <- tms_marrow$Marrow$cell_ontology_class[intersect(
#'   subset_ages,
#'   subset_cell_types
#' )]
...
#'   model = "cCV", ncores = 2, cell.types.cutoff = 10
#' )
